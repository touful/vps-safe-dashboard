...
| [TEST-GEO-001_回归报告.md](TEST-GEO-001_回归报告.md) | DEV-GEO-001 全球攻击地图 + GeoIP + 封禁移除回归 | **PASS_WITH_NOTES**：基线 `0713826`；attacks/geo + attacks_csv + GeoIP reader/updater + 前端地图/封禁移除 6 处全验证；1 Minor（D-1 country=Unknown 过滤大小写不匹配）+ 1 Note；证据 `evidence/TEST-GEO-001/` |
